...
export const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-4 right-4 z-[200] animate-in slide-in-from-bottom-6 duration-700">
      <Card className="p-4 bg-[#1F2128]/95 backdrop-blur-xl border-lux-gold/30 shadow-2xl relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -bottom-2 w-4 h-4 bg-[#1F2128] rotate-45 border-b border-r border-lux-gold/30"></div>
      </Card>
    </div>
  );
};
