      ...
      <Card className="p-8 border-lux-border mb-6 rounded-[2.5rem]">
         <div className="flex flex-col items-center mb-8">
            ...
            >
               ...
               <div className="absolute inset-0 bg-black/50 rounded-full flex items-center justify-center opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity ring-2 ring-lux-gold">
