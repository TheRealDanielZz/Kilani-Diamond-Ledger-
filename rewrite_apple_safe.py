...
if last_brace_idx != -1:
    content = content[:last_brace_idx] + "};" + content[last_brace_idx+3:]
...
content = content.replace(old_movements_filter_1, new_movements_filter_1) # doing it twice might fail if it was replaced entirely. Let's use re.sub just in case
...
new_ui_date = """          <div className="flex flex-wrap items-center gap-2">
